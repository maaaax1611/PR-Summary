...
However, if we assume that all classes share the same covariance matrix and $\Sigma = I$ (Identity matrix), the decision boundary becomes linear.
...
\end{align*}
\noindent where $\| \cdot \|_2$ denotes the $L_2$ norm. Note that this basically is a biased nearest neigbour classifier in the transformed space.\\
