...
\begin{itemize}
    ...
    \begin{figure}[ht!]
        ...
        \label{fig:DeadZones}
    \end{figure}
    \item \textbf{Large Error:} Quadratic for small errors, but constant for large errors. This completely caps the influence of outliers, but the function is non-convex, which makes optimization difficult.
    \begin{equation}
        \phi_{LE} = 
        \begin{cases}
            r^2 & \text{if } |r| \leq a \\
    ...
    \begin{figure}[ht!]
        \centering
        \includegraphics[width=0.8\textwidth]{Large_Error.png}
        \caption{Geometric illustration of the Large Error penalty function}
        \label{fig:LargeError}
    \end{figure}
    ...
    \begin{figure}[ht!]
        \centering
        \includegraphics[width=0.8\textwidth]{HuberLoss.png}
        \caption{Geometric illustration of the Huber Loss}
        \label{fig:HuberLoss}
    \end{figure}
\end{itemize}